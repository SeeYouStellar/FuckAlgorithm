 ...
 * @LastEditTime: 2021-10-29 22:54:36
 * @Description: 
 * @FilePath: \helloworld\fuck\Graph\A1034.cpp
 ...
 * 图中的权值分为点权和边权
 * 
 * 因为该图是有向图，所以边权的计算不仅仅是A---B=10这种，当A与B强连通时，说明A,B相互能到达，那么边权（通话时长）是两段时间相加。而且AB和BA是一样的，这点又与无向图一样。
 * 
 * 点权是和他相接的每条边权相加
 */
#include<bits/stdc++.h>
